...
# Actions: Script will search for the correct community(ies) such as a onesixtyone command (onesixtyone -c /usr/share/seclists/Discovery/SNMP/snmp-onesixtyone.txt 10.129.5.195), then produce a file in CWD for each declaration in the "oids" array
